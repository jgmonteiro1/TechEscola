...
public class SerieProfessor implements Serializable {
	...
	public SerieProfessor() {
		super();
	}

	public SerieProfessor(Long id_disc_serie_prof, Long id_disc_serie, Long id_professor) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SerieProfessor other = (SerieProfessor) obj;
